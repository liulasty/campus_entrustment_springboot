...
public enum TaskStatus {
    ...
    AUDITING("AUDITING",1,"审核中"),
    /**
     * 审核未通过
     */
    @ApiModelProperty(value = "未通过")
    AUDIT_FAILED("AUDIT_FAILED",2,"审核未通过"),
    /**
     * 待发布
     */
    @ApiModelProperty(value = "等待发布")
    PENDING_RELEASE("PENDING_RELEASE",3,"等待发布"),
    /**
     * 委托发布中
     */
    @ApiModelProperty(value = "委托发布中")
    ONGOING("ONGOING",4,"委托发布中"),
    /**
     * 已接收
     */
    @ApiModelProperty(value = "已接收")
    ACCEPTED("ACCEPTED",5,"已接收"),
    /**
     * 已完成
     */
     ...
     */
    TaskStatus(String dbValue,Integer code,String webValue) {
